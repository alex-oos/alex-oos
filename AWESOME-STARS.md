...
- [fastapi-practices/fastapi_best_architecture](https://github.com/fastapi-practices/fastapi_best_architecture) - Based on the FastAPI framework backend architecture solution, following the pseudo 3-tier architecture design, supporting Python 3.10 and above versions. 基于 FastAPI 框架的后端架构解决方案，遵循伪三层架构设计， 支持 Python 3.
